...
public class TaskIntegrationTests extends IntegrationTest{
    @Test
    public void getAll() {
        final ResponseEntity<List<Task>> tasks = testRestTemplate.exchange(
                "/task",
                HttpMethod.GET,
                null,
    ...
    public void insertWithoutDescription() {
        ...
        final ResponseEntity<Long> addTaskResponse = testRestTemplate.postForEntity(
                "/task",
                addRequest,
                Long.class
        );
        ...
        final ResponseEntity<Task> getResponse = testRestTemplate.getForEntity(
                "/task/" + id,
                Task.class
        );
    ...
    public void getTask() {
        ...
        final ResponseEntity<Task> task = testRestTemplate.getForEntity(
                "/task/" + id,
                Task.class
        );
    ...
    public void assignWrongUser() {
        ...
        final ResponseEntity<BadRequestException> updateResponse = testRestTemplate.exchange(
                "/task/" + id + "/assign",
                HttpMethod.PUT,
                new HttpEntity(assignRequest),
    ...
    private long insertTask(TaskAddRequest request) {
        final ResponseEntity<Long> task = testRestTemplate.postForEntity(
                "/task",
                request,
                Long.class
        );
