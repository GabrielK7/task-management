...
import sk.taskmanager.task_management_system.implementation.jpa.repository.ProjectJpaRepository;
...
public class ProjectServiceJpaImpl implements ProjectService {
    ...
    public Project get(long id) {
        return repository.findById(id)
                ...
                .orElseThrow(() -> new ResourceNotFoundException("Project by id " + id + "was not found"));
    }
